...
class Failed_logins_model extends MY_Model {
    ...
    var $column_order = array(null, 'ip_address','username','password','attempt_time'); //set column field database for datatable orderable
	
    var $column_search = array('ip_address','username','password','attempt_time'); //set column field database for datatable searchable 
    ...
    */
	public function insert_failed_login($data){
			...
			$query = $this->db->insert('failed_logins', $data);
	...
	public function count_failed_logins(){
		...
		$count_failed_logins = $this->db->get('failed_logins');
