...
class Page_metadata_model extends MY_Model {
	...
	/**
		...
		* @param $array
		*/		
		public function insert_page_metadata($data){
			
			$query  = $this->db->insert('page_metadata', $data);
		...
		****/
		public function get_page_metadatas($limit, $offset){
			
			$this->db->limit($limit, $offset);
			$this->db->order_by('id','DESC');
			$q = $this->db->get('page_metadata');
		...
		*/	
		public function update_page_metadata($data, $id){
			...
			$this->db->where('id', $id);
			$query = $this->db->update('page_metadata', $data);
