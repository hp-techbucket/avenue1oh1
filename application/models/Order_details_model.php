...
class Order_details_model extends MY_Model {
    ...
    var $column_order = array(null, 'order_reference','product_id','quantity','price','customer_email'); //set column field database for datatable orderable
	
    var $column_search = array('order_reference','product_id','quantity','price','customer_email'); //set column field database for datatable searchable 
