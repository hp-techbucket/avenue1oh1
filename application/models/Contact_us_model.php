...
class Contact_us_model extends MY_Model {
    ...
    var $column_order = array(null, 'contact_name','contact_telephone','contact_email','contact_company','contact_message','opened','contact_us_date'); //set column field database for datatable orderable
	
    var $column_search = array('contact_name','contact_telephone','contact_email','contact_company','contact_message','opened','contact_us_date'); //set column field database for datatable searchable 
    ...
    public function count_all()
    {
		...
		public function add_contact_us($contact_data){
			...
			$query = $this->db->insert('contact_us', $contact_data);
			if ($query){
				return true;
			}else {
				return false;
		...
		public function get_contact_us($limit, $start){
			...
			$contacts = $this->db->get('contact_us');
		...
		public function count_all_messages(){
			...
			$count_messages = $this->db->get('contact_us');
