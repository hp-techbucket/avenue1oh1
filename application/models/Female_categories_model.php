...
class Female_categories_model extends MY_Model {
    
    const DB_TABLE = 'female_categories';
    const DB_TABLE_PK = 'id';


	var $table = 'female_categories';
	...
	* to the female categories table in the database
