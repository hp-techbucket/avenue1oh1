...
class Logins_model extends MY_Model {
    ...
    var $column_order = array(null, 'ip_address','username','password','login_time'); //set column field database for datatable orderable
	
    var $column_search = array('ip_address','username','password','login_time'); //set column field database for datatable searchable 
    ...
    */
	public function insert_login($data){
			...
			$query = $this->db->insert('logins', $data);
    ...
    */	
	...
	public function count_logins(){
		...
		$count_logins = $this->db->get('logins');
		...
		public function insert_failed_reset(){
			...
			$query = $this->db->insert('failed_resets', $data);
