...
class Shipping_model extends MY_Model {
   ...
   var $column_order = array(null, 'reference','shipping_fee','shipping_method','customer_email','shipping_date'); //set column field database for datatable orderable
		
		var $column_search = array('reference','shipping_fee','shipping_method','customer_email','shipping_date'); //set column field database for datatable searchable  
