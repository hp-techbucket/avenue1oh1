...
class Default_address_model extends MY_Model {
    
    const DB_TABLE = 'default_address';
    const DB_TABLE_PK = 'id';


	var $table = 'default_address';
    ...
    public function count_all()
    {
		...
		*/	
		...
		/****
		** Function to get user's default address from the database
		**	variable $email
		****/
		...
		* variable $id
		*/	
		public function update_default($data, $email){
