...
class Site_activities_model extends MY_Model {
    ...
    const DB_TABLE_PK = 'id';
		...
		var $column_order = array(null, 'name','email','description','keyword','activity_time'); //set column field database for datatable orderable
		
		var $column_search = array('name','email','description','keyword','activity_time'); //set column field database for datatable searchable 
		...
		*/	
		...
		public function get_user_activities($limit=5, $start=0, $username){
