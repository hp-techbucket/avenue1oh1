...
class Password_resets_model extends MY_Model {
    ...
    var $column_order = array(null, 'email','security_answer','activation_code','request_date'); //set column field database for datatable orderable
	
    var $column_search = array('email','security_answer','activation_code','request_date'); //set column field database for datatable searchable 
    ...
    var $order = array('id' => 'desc'); // default order 
		...
		*/	
		...
		public function insert_password_resets(){
			
			$query = $this->db->insert('password_resets', $data);
		...
		*/			
		public function is_valid_key($key){
			...
			$security_answer = $this->session->flashdata('security_answer');
		...
		* exists in the database
		*/	
		public function unique_password_reset($username,$email){
