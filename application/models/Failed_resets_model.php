...
class Failed_resets_model extends MY_Model {
    ...
    var $column_order = array(null, 'ip_address','email_address','security_answer','attempt_time'); //set column field database for datatable orderable
	
    var $column_search = array('ip_address','email_address','security_answer','attempt_time'); //set column field database for datatable searchable 
    ...
    */
	public function insert_failed_reset($data){
		...
		****/
		function get_failed_resets($limit = 10, $offset = 0){
	...
	public function count_failed_resets(){
