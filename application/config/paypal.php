 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'paypal_api1.getextra.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '2LG59XLXFEL4TSXY' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31ATfp8r.X.pgqNOdD9Jj5varqJoyZ' : 'PRODUCTION_SIGNATURE_GOES_HERE';

//paypal configuration
$config['api_username'] = 'paypal_api1.getextra.com';
$config['api_password'] = '2LG59XLXFEL4TSXY';
$config['api_signature'] = 'AFcWxV21C7fd0v3bYYYRCpSSRl31ATfp8r.X.pgqNOdD9Jj5varqJoyZ';
$config['test_mode'] = TRUE; //keep false on production, true for test
$config['currency'] = 'USD';
$config['return'] = 'http://localhost/websites/getextra/account/paypal_process/';
$config['cancel_return'] = 'http://localhost/websites/getextra/account/deposit_failure/';
$config['notify_url'] = 'http://localhost/websites/getextra/payment/save_transaction/';
$config['business'] = 'paypal@getextra.com';

$PayPalMode 			= 'sandbox'; // sandbox or live
$PayPalApiUsername 		= 'paypal_api1.getextra.com'; //PayPal API Username
$PayPalApiPassword 		= '2LG59XLXFEL4TSXY'; //Paypal API password
$PayPalApiSignature 	= 'AFcWxV21C7fd0v3bYYYRCpSSRl31ATfp8r.X.pgqNOdD9Jj5varqJoyZ'; //Paypal API Signature
$PayPalCurrencyCode 	= 'USD'; //Paypal Currency Code
$PayPalReturnURL 		= 'http://localhost/websites/getextra/account/paypal_process/'; //Point to process.php page
$PayPalCancelURL 		= 'http://localhost/websites/getextra/account/deposit_failure/'; //Cancel URL if user clicks cancel
/*
