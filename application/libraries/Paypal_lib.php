...
class paypal_lib {
	...
	function paypal_auto_form() 
	{
		...
		echo '<title>Avenue 1-OH-1 | Processing Payment...</title></head>' . "\n";
		...
		echo '<br/>' . "\n";
		echo '<p style="text-align:center;"><img src="'.site_url('assets/images/gif/plz_wait.gif').'" width="150" height="150"/></p>' . "\n";
