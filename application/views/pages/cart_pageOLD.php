								...
								<div class="table-responsive" align="center">
									<table frame="box" class="table table-hover table-striped">
										...
										<tbody>
												...
												<tr>
													...
													<td>
														...
														<form class="form-inline" id="update_cart_form" action="<?php echo base_url('store/update_cart'); ?>" method="post" enctype="multipart/form-data">
															...
															<button name="adjustBtn<?php echo $item_id; ?>" type="submit" class="btn btn-info">Update</button>
														</form>
											...
											<tr>
												<td colspan="3"><a title="Continue Shopping" class="btn btn-success btn-block" href="javascript:void(0)" onclick="location.href='<?php echo base_url('collections/all/');?>'">Continue Shopping</a></td>
