							...
							<div class="col-lg-8 col-lg-offset-2">
								...
								<div id="shoppingBag">
									<h4 class="text-center">
										<b><i class="fa fa-shopping-cart"></i> Your Cart</b>
									</h4>
									...
									<?php
										...
										if(!empty($_SESSION["cart_array"])){
											...
											foreach($_SESSION["cart_array"] as $each_item){
												...
												if(file_exists($filename)){
													...
													$thumbnail = '<a href="'.base_url().'collections/product/'.strtolower(html_escape($item_id)).'/'.url_title(strtolower(html_escape($product_name))).'" title="'.ucwords(html_escape($product_name)).'"><img src="'.base_url().'uploads/products/'.$item_id.'/'.$item_id.'.jpg" class="img-responsive" alt="item'.$item_id.'"/></a>';
																				
												}else if($product_image == '' || $product_image == null || !file_exists($filename)){
																				
													$thumbnail = '<a href="'.base_url().'collections/product/'.strtolower(html_escape($item_id)).'/'.url_title(strtolower(html_escape($product_name))).'" title="'.ucwords(html_escape($product_name)).'"><img src="'.base_url().'assets/images/icons/no-default-thumbnail.png" class="img-responsive img-rounded"  alt="item'.$item_id.'" /></a>';
																				
												}else{
																				
													$thumbnail = '<a href="'.base_url().'collections/product/'.strtolower(html_escape($item_id)).'/'.url_title(strtolower(html_escape($product_name))).'" title="'.ucwords(html_escape($product_name)).'"><img src="'.base_url().'uploads/products/'.$item_id.'/'.$product_image.'" class="img-responsive img-rounded" alt="item'.$item_id.'" /></a>';
											...
											<div class="row shopping-cart-items">
												...
												<div class="col-xs-7">
													<h5>
														<a href="<?php echo base_url(); ?>collections/product/<?php echo strtolower(html_escape($item_id));?>/<?php echo url_title(strtolower(html_escape($product_name)));?>" title="<?php echo ucwords(html_escape($product_name));?>"><?php echo ucwords(html_escape($product_name));?></a>
																				
														<span class="pull-right">
															<a href="#" title="Remove Item" class="remove-item" id="<?php echo $i; ?>-<?php echo $item_id; ?>"><i class="fa fa-times" aria-hidden="true"></i></a>
														</span>
													</h5>
													<p><?php echo $product_qty ; ?> X $<?php echo $price ; ?></p>
																				
												</div>
												<div class="col-xs-2">
													<span class="pull-right"><a href="#" title="Remove Item" class="remove-item" id="<?php echo $i; ?>-<?php echo $item_id; ?>"><i class="fa fa-times" aria-hidden="true"></i></a></span>
												</div>							
											</div>
											<hr/>
										<?php
										...
										?>
											<div class="row shopping-cart-header">
												<div class="col-xs-7">
													<h4 class="text-center"><b>SUBTOTAL :</b></h4>
												</div>
												<div class="col-xs-5">
													<div class="shopping-cart-total text-left">
														<h4 class="lighter-text"><?php echo $cartTotal; ?></h4>
													</div>
												</div>
											</div> <!--end shopping-cart-header -->
																
											<div class="cart-buttons">
												<p><a title="VIEW SHOPPING BAG" href="javascript:void(0)" onclick="location.href='<?php echo base_url('cart/');?>'" class="btn btn-white btn-block">VIEW SHOPPING BAG <i class="fa fa-shopping-bag"></i>(<?php echo $cart_count ;?>)</a></p>
																	
												<p><a title="Checkout" href="javascript:void(0)" onclick="location.href='<?php echo base_url('checkout/');?>'" class="btn btn-orange btn-block"><i class="fa fa-chevron-right" aria-hidden="true"></i> CHECKOUT</a></p>
