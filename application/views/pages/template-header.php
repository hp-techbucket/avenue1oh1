          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
			  ...
			  <ul class="nav navbar-nav navbar-right">
				...
				<li><a title="Cart" href="javascript:void(0)" onclick="location.href='<?php echo base_url('store/cart/');?>'"><i class="fa fa-shopping-cart" aria-hidden="true"></i> <span class="badge" id="cart_contents"><?php echo $cart_count ;?></span></a></li>
