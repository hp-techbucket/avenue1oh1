							...
							<div class="collection-item col-md-4 col-sm-6 col-xs-12">
								...
								<div class="card hoverable">
									...
									<div class="card-image">
											<img src="<?php echo base_url(); ?>assets/images/collections/women/<?php echo strtolower(html_escape($row['category_name']))?>.jpg" class="img-responsive" alt="collection-<?php echo strtolower(html_escape($row['category_name']))?>" >
						...
						<a href="<?php echo base_url(); ?>collections/men/<?php echo strtolower(html_escape($row['category_name']))?>" >
							...
							<div class="collection-item col-md-4 col-sm-6 col-xs-12">
								...
								<div class="card hoverable">
									<!-- .card-image-->
									<div class="card-image">
											<img src="<?php echo base_url(); ?>assets/images/collections/men/<?php echo strtolower(html_escape($row['category_name']))?>.jpg" class="img-responsive" alt="collection-<?php echo strtolower(html_escape($row['category_name']))?>" >
											<div class="collection-caption">
												SHOP THE COLLECTION
											</div>
									</div>
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="alert alert-danger" role="alert">
									<h4 class="text-danger text-center"><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span><span class="sr-only"></span>None!</h4>
								</div>
							</div>
						</div>
						<?php
