				...
				<div class="products-display-wrapper">
					...
					//	$result = $this->db->get();
						if($products_array) {
							...
							$x = 0;
							//start row
							echo '<div id="products" class="row list-group products">';
							...
							<div class="item-wrapper">
								...
								<div class="thumbnail">
									...
									<div class="caption-wrap">
										...
										<!-- .caption-->
										<div class="caption">
											<h4 class="group inner list-group-item-heading"><a href="<?php echo $product_link; ?>" title="<?php echo ucwords(html_escape($product->name));?>"><?php echo ucwords(html_escape($product->name));?> (<?php echo $quantity_available;?>)</a></h4>
											<p class="price group inner list-group-item-text">$<?php echo html_escape(number_format($product->price, 2)) ;?> </p>
											
											<p class="stock small group inner list-group-item-text"><b><?php echo html_escape($current_stock) ;?> </b></p>
										</div>
										<!-- .caption-->
										...
										<div class="social-sharing-btns">
											<ul class="list-inline">
												...
												<li>
													...
													<a href="#" class="<?php echo $disabled_link; ?>" title="Add to cart" onclick="toggleOptions(this, event)">
														<div class="social-icon">
										...
										<div class="sharing-icons">
											<div class="icon-list">
												<a target="_blank" href="//www.facebook.com/sharer.php?u=<?php echo $product_link; ?>" class="">
													<i class="fa fa-facebook" aria-hidden="true"></i>
												</a>
											</div>
											<div class="icon-list">
												<a target="_blank" href="//twitter.com/share?url=<?php echo $product_link; ?>&amp;text=<?php echo ucwords(html_escape($product->name));?>" class="">
													<i class="fa fa-twitter" aria-hidden="true"></i>
												</a>
											</div>
											<div class="icon-list">
												<a target="_blank" href="//pinterest.com/pin/create/button/?url=<?php echo $product_link; ?>&amp;media=<?php echo $pinterest_image_url; ?>&amp;description=<?php echo ucwords(html_escape($product->name));?>" class="">
