	...
	<div class="navbar-wrapper">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li class="dropdown cart">
				...
				<a href="#" class="dropdown-toggle cart-dropdown" onclick="getCart();" data-toggle="dropdown"><i class="fa fa-shopping-cart" aria-hidden="true"></i> <span class="badge" id="cart_contents"><?php echo $cart_count ;?></span></a>
										...
										if(!empty($_SESSION["cart_array"])){
											...
											foreach($_SESSION["cart_array"] as $each_item){
												...
												if(file_exists($filename)){
													...
													$thumbnail = '<img src="'.base_url().'assets/images/icons/no-default-thumbnail.png" class="img-responsive img-rounded"  alt="item'.$item_id.'" />';
																				
												}else{
																				
													$thumbnail = '<img src="'.base_url().'uploads/products/'.$item_id.'/'.$product_image.'" class="img-responsive img-rounded" alt="item'.$item_id.'" />';
											...
											<div class="row shopping-cart-items">
												...
												<a href="<?php echo base_url(); ?>collections/product/<?php echo strtolower(html_escape($item_id));?>/<?php echo url_title(strtolower(html_escape($product_name)));?>" title="<?php echo ucwords(html_escape($product_name));?>">
												...
												<div class="col-md-7 col-xs-6">
													<h5>
														<b><a href="<?php echo base_url(); ?>collections/product/<?php echo strtolower(html_escape($item_id));?>/<?php echo url_title(strtolower(html_escape($product_name)));?>" title="<?php echo ucwords(html_escape($product_name));?>"><?php echo ucwords(html_escape($product_name));?></a></b>
												...
												<div class="col-md-2 col-xs-6">
													<span class="pull-right"><a href="#" title="Remove Item" onclick="removeItem(this,<?php echo $i; ?>,<?php echo $item_id; ?>);" class="remove-item" id="<?php echo $i; ?>-<?php echo $item_id; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a></span>
												</div>							
											</div>
											<hr class="style-custom"/>
										<?php
												$i++;
											}
