                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="javascript:void(0)" onclick="location.href='<?php echo base_url();?>admin/paypal_payment_methods/'" title="Card Payment Methods" ><i class="fa fa-cc-paypal"></i> PayPal Payment Methods</a>
                            </li>							
                        </ol>
                    </div>
                </div>
...
<p><?php echo nbs(2);?> <?php echo img('assets/images/crookedArrow.png');?> <button class="btn btn-danger" data-toggle="modal" data-target="#myModal" id="deleteButton" ><i class="fa fa-trash-o"></i> Delete</button></p>   								
                    ...
                    <div class="col-lg-12">
						...
						<div class="table-responsive" align="center">
							<table frame="box" class="table table-hover table-striped">
								...
								<tbody>
	<?php
							if($card_payment_methods_array){
								
								foreach($card_payment_methods_array as $card){	
	...
	?>							
									<tr>
										...
										<td><?php echo $card->expiry_month ; ?></td>
										<td><?php echo $card->expiry_year ; ?></td>
										<td><?php echo $card->card_cvc; ?></td>
										
										<td><?php echo $card->user_email ; ?></td>										
										<td><?php echo date("F j, Y", strtotime($card->date_added)); ?></td>
										<td>
										<a data-toggle="modal" data-target="#viewModal" class="btn btn-default view_card_details"  id="<?php echo html_escape($card->id);?>" title="View Credit Card details"><i class="fa fa-search"></i></a>
										</td>
									</tr>											
	<?php
								}
...
?>
								  <tr>
									<td colspan="11" align="center"><div class="alert alert-danger" role="alert">
									  ...
									  <span class="sr-only"></span> No card payment methods!</div>
									</td>
								  </tr>
